	    ...
	    $scope.authObj.$onAuth(function(authData) {
		  if (authData) {
			...
			if (authData.provider = "facebook") {
				...
				$http({ method: 'POST', url: '../scripts/php/mongoTestConection.php?&firstName='+facebookObject.first_name+'&lastName='+facebookObject.last_name+'&points='+score+'&provider='+authData.provider+'&category='+category+'&title='+$scope.task+'&id='+$scope.itemId
				...
				$http({ method: 'POST', url: '../scripts/php/mongoTestConection.php?&firstName='+googleObject.given_name+'&lastName='+googleObject.family_name+'&points='+score+'&provider='+authData.provider+'&category='+category+'&title='+$scope.task+'&id='+$scope.itemId
				}).success(function(data){
					$scope.stat = true;
					console.log(data);
				}).error(function(data){
